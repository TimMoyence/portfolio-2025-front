...
- Name: auth.spec.ts >> Auth — Page de connexion >> la page login affiche le formulaire avec email et mot de passe
...
Locator: locator('#auth-tab-log-in input[name="email"]')
Expected: visible
Timeout: 5000ms
