...
export { SlideStatsComponent, type SlideStat } from './layouts/slide-stats/slide-stats.component';
...
export { SlideGridComponent, type SlideGridItem } from './layouts/slide-grid/slide-grid.component';
