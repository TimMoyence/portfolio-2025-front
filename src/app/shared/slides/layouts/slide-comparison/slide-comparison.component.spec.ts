...
import { type ComparisonColumn, SlideComparisonComponent } from './slide-comparison.component';

@Component({
  standalone: true,
  imports: [SlideComparisonComponent],
  template: ` <app-slide-comparison title="Avant / Après IA" [columns]="columns" /> `,
})
class HostComponent {
...
describe('SlideComparisonComponent', () => {
  ...
  it('rend N colonnes (3) dynamiquement', () => {
    ...
    fixture.detectChanges();
    const cols = fixture.nativeElement.querySelectorAll('.slide-comparison__column');
  ...
  it('expose le nombre de colonnes via --cols', () => {
    const fixture = TestBed.createComponent(HostThreeComponent);
    fixture.detectChanges();
    const grid: HTMLElement = fixture.nativeElement.querySelector('.slide-comparison__grid');
