...
describe('SlideReflectionComponent', () => {
  ...
  it('rend prompt et textarea', fakeAsync(() => {
    ...
    tick();
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('.slide-reflection__prompt').textContent).toContain(
      'Quelle tâche',
    );
  ...
  it('affiche un message de validation après save', fakeAsync(() => {
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('.slide-reflection__saved')).toBeTruthy();
  }));
});
