...
export class SeoService {
  ...
  updateSeoMetadata(config: SeoConfig): void {
    ...
    this.meta.updateTag({ name: 'twitter:title', content: config.twitterTitle || config.ogTitle || config.title });
    this.meta.updateTag({ name: 'twitter:description', content: config.twitterDescription || config.ogDescription || config.description });
