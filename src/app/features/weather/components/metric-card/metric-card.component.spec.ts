...
describe('MetricCardComponent', () => {
  ...
  describe('SSR (PLATFORM_ID: server)', () => {
    ...
    beforeEach(async () => {
      ...
      ssrWeatherPortStub.getPreferences.and.returnValue(of(buildWeatherPreferences()));
      ssrWeatherPortStub.updatePreferences.and.returnValue(of(buildWeatherPreferences()));
