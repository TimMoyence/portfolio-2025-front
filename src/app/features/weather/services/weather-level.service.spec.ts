...
describe('WeatherLevelService', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [WeatherLevelService, { provide: WEATHER_PORT, useValue: weatherPortStub }],
    });
  ...
  describe('loadPreferences', () => {
    ...
    it('devrait gerer les erreurs de chargement', () => {
      weatherPortStub.getPreferences.and.returnValue(throwError(() => new Error('Network error')));
  ...
  describe('setLevel', () => {
    ...
    it("devrait garder le niveau meme en cas d'erreur backend", () => {
      weatherPortStub.updatePreferences.and.returnValue(throwError(() => new Error('Error')));
