  ...
  template: `
    ...
    >
      ...
      <div class="mt-6 overflow-hidden rounded-[1.5rem] border border-[#ddd5c7]">
        <div class="grid grid-cols-[1.4fr_0.7fr_0.7fr_0.7fr] gap-4 bg-[#f7f1e8] px-4 py-3 text-xs font-bold uppercase tracking-[0.18em] text-slate-500">
          <span>Category</span>
          <span>Plan</span>
          <span>Fact</span>
          <span>Left</span>
        ...
        @for (item of totals(); track item.name) {
          ...
          >
            <div class="flex items-center gap-3">
              <span class="font-medium text-slate-700">{{ displayName(item.name) }}</span>
              <span
