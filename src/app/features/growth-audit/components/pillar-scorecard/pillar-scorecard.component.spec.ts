...
describe('PillarScorecardComponent', () => {
  ...
  it('devrait rendre une carte par pilier de la scorecard', () => {
    ...
    const cards = fixture.nativeElement.querySelectorAll("[data-testid='pillar-card']");
  ...
  it('devrait appliquer la classe de statut critical/warning/ok', () => {
    ...
    const badges = fixture.nativeElement.querySelectorAll("[data-testid='pillar-status']");
