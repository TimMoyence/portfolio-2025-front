...
describe('SebastianHistoryComponent', () => {
  ...
  it('devrait afficher toutes les entrees', () => {
    const items = fixture.nativeElement.querySelectorAll("[data-testid='entry-item']");
  ...
  it('devrait afficher les controles de filtre', () => {
    const categoryFilter = fixture.nativeElement.querySelector("[data-testid='category-filter']");
