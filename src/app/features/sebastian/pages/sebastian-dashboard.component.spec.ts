...
describe('SebastianDashboardComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: SEBASTIAN_PORT, useValue: portStub }, provideRouter([])],
    }).compileComponents();
  ...
  it('devrait afficher le composant ScoreCard', () => {
    const scoreCard = fixture.nativeElement.querySelector('app-sebastian-score-card');
    expect(scoreCard).toBeTruthy();
  });

  it('devrait afficher deux composants TrendChart', () => {
    const charts = fixture.nativeElement.querySelectorAll('app-sebastian-trend-chart');
