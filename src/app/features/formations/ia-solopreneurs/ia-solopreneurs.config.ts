...
export const iaSolopreneursFormation: FormationConfig = {
  ...
  metadata: {
    ...
    description: {
      fr: $localize`:@@formations.ia-solopreneurs.metadata.description.fr:16 outils d'intelligence artificielle testes en conditions reelles pour solopreneurs, freelances et petites equipes. Formation gratuite de 30 minutes qui couvre les cas d'usage concrets : generation de contenu, prospection, automatisation, veille, creation visuelle, podcasting. Chaque outil est compare sur les criteres qui comptent pour un independant : cout mensuel, courbe d'apprentissage, gain de temps reel, limites rencontrees. Ni promesse marketing ni demonstration technique hors-sol : des exemples tires de ma pratique quotidienne a Bordeaux, avec les prompts qui fonctionnent et ceux qui ne passent pas. A la fin, vous repartez avec un plan d'action concret pour cette semaine, un cheatsheet PDF personnalise selon votre secteur et 30 prompts prets a copier-coller.`,
      en: $localize`:@@formations.ia-solopreneurs.metadata.description.en:16 AI tools tested in real-world conditions for solopreneurs, freelancers and small teams. A free 30-minute training covering the use-cases that actually matter: content generation, prospecting, automation, monitoring, visual creation, podcasting. Every tool is evaluated on solopreneur criteria: monthly cost, learning curve, real time savings, hard limits observed. No marketing promises, no out-of-context demos: examples from my daily practice in Bordeaux, with the prompts that work and the ones that fail. You leave with an action plan for this week, a PDF cheatsheet personalised by sector and 30 ready-to-copy prompts.`,
    },
    tagline: {
