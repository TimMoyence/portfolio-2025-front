...
export class FormationsListComponent {
  ...
  protected readonly heroLead = $localize`:@@formationsHeroLead:Des formations gratuites au format slides interactives — avec quiz, sondages et séances accompagnées — plus un accompagnement sur mesure pour ancrer les usages IA dans le management. Consultables en ligne ou projetables en présentation. Des réponses actionnables, pas un cours universitaire. Sans inscription : votre email sert seulement à recevoir le toolkit PDF.`;
