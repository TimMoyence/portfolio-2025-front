...
export const FORMATIONS: readonly FormationCard[] = [
  {
    ...
    badge: $localize`:@@formations-list.b2.badge:BTS CG · Cours interactif · 53 écrans`,
    title: $localize`:@@formations-list.b2.title:B2-01 — Lire et contrôler l’information chiffrée`,
    description: $localize`:@@formations-list.b2.description:53 écrans pour lire, contrôler et expliquer une information chiffrée : proportions, pourcentages, évolutions. À suivre en séance accompagnée, avec le code donné par votre formateur.`,
    meta: [
      {
        key: $localize`:@@formations-list.meta.duration:Durée`,
        value: $localize`:@@formations-list.b2.duration:3 h 30 · 53 écrans`,
      },
      {
